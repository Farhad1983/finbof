...
def print_results_df(printOrginal = False):
    #model_names = ['final_cnn','final_gru','final_lstm','final_bof','final_MLLSTM','final2_MLLSTM','final3_MLLSTM','ML_CNN_NN','final_MLbof']
...
def print_results_CNN_df(printOrginal = False):
    model_names = ['final_cnn','ML_CNN_NN']
    metrics = ['acc_mean','acc_std','precision_mean','precision_std','recall_mean','recall_std','f1_mean','f1_std','kappa_mean','kappa_std']
    df = pd.DataFrame(columns=metrics, index = model_names)    
...
def print_results_lstm_df(printOrginal = False):
    model_names = ['final_lstm','final_MLLSTM']
    metrics = ['acc_mean','acc_std','precision_mean','precision_std','recall_mean','recall_std','f1_mean','f1_std','kappa_mean','kappa_std']
    df = pd.DataFrame(columns=metrics, index = model_names)    
...
def print_results_bof_df(printOrginal = False):
    model_names = ['final_bof','final_MLbof']
    metrics = ['acc_mean','acc_std','precision_mean','precision_std','recall_mean','recall_std','f1_mean','f1_std','kappa_mean','kappa_std']
    df = pd.DataFrame(columns=metrics, index = model_names)    
